...
class HMRSTrial(Trial):
    def __init__(self, config, trial_id: int, headless: bool = True, network_name: str = "", path_to_world: str = "",
                 use_rviz: bool = True, logger_args: list = None, logger_kwargs: dict = None):
